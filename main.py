...
# Pregnancies: Burada hastanın kaç defa hamile kaldığı belirtilmiştir
# Glucose: Hastanın glikoz değerleri 2 saatlik süreçte incelenmiştir
# Blood Pressure: Kan basıncı değerleridir. 0 ile 122 arasında değerler almıştır.
# Skin Thickness: Triceps cilt kıvrım kalınlığı değeridir. 0 ile 99 arasında değerler almıştır
# İnsülin: 2 saatlik serum insülini değeridir. 0 ile 846 arasında değerler almıştır
# Body Mass Index: Vücut kitle indeksi, kişinin toplam ağırlığının kişinin boyuna bölünmesi ile bulunmuştur
# Diabetes Pedigree Function: Diyabet soyağacı işlevidir. 0.078 ile 2.42 arasında değerler almıştır
# Age: Hastaların yaşlarını göstermektedir. 21 ile 81 yaşları arasındaki hastaların verileri mevcuttur.
